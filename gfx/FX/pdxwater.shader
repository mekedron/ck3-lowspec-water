...
# game/gfx/FX/pdxwater.shader from CK3 1.19.0.6 (Scribe).
#
# With Advanced Shaders off the ocean is drawn by Effect waterLowSpec: the colour map,
# a shore fade and nothing else - and the shore fade alone costs a 9 tap heightmap
# multisample. Lakes have no low spec effect at all and always run the full water
# shader. This file gives both the same cheap shaded water instead:
...
# The switches live in gfx/FX/better_water_options.fxh. CalcWaterCheap itself is in
# gfx/FX/jomini/jomini_water_default.fxh. Everything else is vanilla.
Includes = {
